...
var l2F8A1F1C_0 = false;
l2F8A1F1C_0 = instance_exists(obj_screen_dimmer);
if(!l2F8A1F1C_0)
{
	...
	/// @DnDParent : 2F8A1F1C
	/// @DnDArgument : "spriteind" "spr_beigesel_close"
	/// @DnDSaveInfo : "spriteind" "spr_beigesel_close"
	with(obj_beigesel) {
	sprite_index = spr_beigesel_close;
	image_index = 0;
	}
