...
with(obj_WasdorArrow) var l559A1099_0 = ControlChoice == "ARROWS";
if(l559A1099_0)
{
	/// @DnDAction : YoYo Games.Common.If_Variable
	/// @DnDVersion : 1
	...
	if(MinigameGoing == "yes")
	{
		...
		/// @DnDArgument : "not" "1"
		var l220D1D99_0;
		l220D1D99_0 = keyboard_check(vk_up);
		if (!l220D1D99_0)
		{
			/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Key_Down
			/// @DnDVersion : 1
			...
			/// @DnDArgument : "not" "1"
			var l0A8A6775_0;
			l0A8A6775_0 = keyboard_check(vk_down);
			if (!l0A8A6775_0)
			{
				/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Key_Down
				/// @DnDVersion : 1
				...
				/// @DnDArgument : "not" "1"
				var l57A6B8F1_0;
				l57A6B8F1_0 = keyboard_check(vk_left);
				if (!l57A6B8F1_0)
				{
					/// @DnDAction : YoYo Games.Mouse & Keyboard.If_Key_Down
					/// @DnDVersion : 1
					...
					/// @DnDArgument : "not" "1"
					var l78D054F0_0;
					l78D054F0_0 = keyboard_check(vk_right);
					if (!l78D054F0_0)
					{
						/// @DnDAction : YoYo Games.Common.If_Variable
						/// @DnDVersion : 1
