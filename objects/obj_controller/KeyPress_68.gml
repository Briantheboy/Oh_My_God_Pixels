...
with(obj_WasdorArrow) var l3040D6F0_0 = ControlChoice == "WASD";
if(l3040D6F0_0)
{
	/// @DnDAction : YoYo Games.Common.If_Variable
	/// @DnDVersion : 1
	...
	if(MinigameGoing == "yes")
	{
		...
		if(room == RIPPLE)
		{
			...
			if(!l05296E00_0)
			{
				...
				if(l16CF581A_0)
				{
					...
					audio_play_sound(sou_waveright, 0, 0, 1.0, undefined, 1.0);
				}
			}
		}
		...
		if(!(ControlAccess == "Stuck"))
		{
			...
			if(room == TELEPORT)
			{
				...
				var l28ACA312_0 = false;
				l28ACA312_0 = instance_exists(obj_win);
				if(!l28ACA312_0)
				{
					/// @DnDAction : YoYo Games.Audio.Play_Audio
					/// @DnDVersion : 1.1
