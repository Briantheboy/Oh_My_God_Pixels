...
var l573C5568_0 = false;
l573C5568_0 = instance_exists(obj_screen_dimmer);
if(!l573C5568_0)
{
	...
	/// @DnDParent : 573C5568
	/// @DnDArgument : "spriteind" "spr_hotpinksel_close"
	/// @DnDSaveInfo : "spriteind" "spr_hotpinksel_close"
	with(obj_hotpinksel) {
	sprite_index = spr_hotpinksel_close;
	image_index = 0;
	}
