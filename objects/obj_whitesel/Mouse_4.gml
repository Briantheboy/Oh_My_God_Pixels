...
var l415C8FFD_0 = false;
l415C8FFD_0 = instance_exists(obj_screen_dimmer);
if(!l415C8FFD_0)
{
	...
	/// @DnDParent : 415C8FFD
	/// @DnDArgument : "spriteind" "spr_whitesel_close"
	/// @DnDSaveInfo : "spriteind" "spr_whitesel_close"
	with(obj_whitesel) {
	sprite_index = spr_whitesel_close;
	image_index = 0;
	}
