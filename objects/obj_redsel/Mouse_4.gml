...
var l51FC72B3_0 = false;
l51FC72B3_0 = instance_exists(obj_screen_dimmer);
if(!l51FC72B3_0)
{
	...
	/// @DnDParent : 51FC72B3
	/// @DnDArgument : "spriteind" "spr_redsel_close"
	/// @DnDSaveInfo : "spriteind" "spr_redsel_close"
	with(obj_redsel) {
	sprite_index = spr_redsel_close;
	image_index = 0;
	}
