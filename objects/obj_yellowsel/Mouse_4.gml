...
var l26095106_0 = false;
l26095106_0 = instance_exists(obj_screen_dimmer);
if(!l26095106_0)
{
	...
	/// @DnDParent : 26095106
	/// @DnDArgument : "spriteind" "spr_yellowsel_close"
	/// @DnDSaveInfo : "spriteind" "spr_yellowsel_close"
	with(obj_yellowsel) {
	sprite_index = spr_yellowsel_close;
	image_index = 0;
	}
