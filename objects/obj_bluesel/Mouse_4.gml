...
var l33FDC378_0 = false;
l33FDC378_0 = instance_exists(obj_screen_dimmer);
if(!l33FDC378_0)
{
	...
	/// @DnDParent : 33FDC378
	/// @DnDArgument : "spriteind" "spr_bluesel_close"
	/// @DnDSaveInfo : "spriteind" "spr_bluesel_close"
	with(obj_bluesel) {
	sprite_index = spr_bluesel_close;
	image_index = 0;
	}
